        ...
        <div class="col-sm-9 col-md-7 col-lg-5 mx-auto">
            <div class="card card-signin my-5">
                <div class="card-body">
                    ...
                    <div class="row">
                        <div class="col">
                            <?php if($this->session->flashSdata('message')) : ?>
                    ...
                    <div class="form-label-group">
                        <input type="password" name="new" value="" class="form-control" id="new_password"
                    ...
                    <div class="form-label-group">
                        <input type="password" name="new_confirm" id="new_password_confirm" value=""
                    ...
                    <button class="btn btn-lg btn-primary btn-block text-uppercase"
                        type="submit"><?= lang('reset_password_submit_btn') ?></button>
