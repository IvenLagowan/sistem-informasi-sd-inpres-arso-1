	...
	<?= form_open_multipart($form_action) ?>
		...
		<div class="form-group row">
			...
			<div class="col-sm-8">
				<?php if(!empty($content->photo)) : ?>
					<img src="<?= base_url("img/background/$content->photo") ?>" height="150">
				<?php else: ?>
					<p>No Photo</p>
				<?php endif; ?>
				<br> 
		...
		<div class="row mt-4">
			<div class="col-8 offset-2">
				<a href="<?= base_url('background') ?>" class="btn btn-sm btn-secondary"><i class="fas fa-angle-left mr-1"></i>Kembali</a>
